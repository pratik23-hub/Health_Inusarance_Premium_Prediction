...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('D:\Downloads\Insurance_premium_prediction/insurance_dataset.csv')
            logging.info('Read the dataset as succesfully')
...
if __name__=="__main__":
    ...
    train_arr,test_arr,extra_var=data_transformation.initiate_data_transformation(train_data,test_data)
